...
% the sentence starting with "therefore" lacks a verb
...
% replace this next paragraph with some text about how search based program repair depends on patterns, and we have patterns that we have found to be used in actual repairs. That should go at the top of 5.1.

% say why you're talking about GenProg etc.
...
% say why pattern-based repair is different from search-based repair
...
% again, say how we are like or unlike these works

\subsection{Code Patterns in Rust}

% say how is this related to our work?
