...
\begin{itemize}
    ...
    \item refactoring: The software behavior remains unchanged after the code change. These changes are made for imporving codebase's maintainability, better readability or encapsulation.
\end{itemize}
