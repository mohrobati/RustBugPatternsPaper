...
\todo{recap the italicized stuff from above}
\vspace*{1em}
\fbox{\parbox{0.9\textwidth}{We summarize learnings from our bug patterns as follows:
\begin{itemize}
\item one
\item two
\end{itemize}
