...
\signature{Mohammad Robati Shirzad and Patrick Lam}
...
\begin{itemize}
    ...
    \item We propose a novel code embedding method. Our method is simple, highly interpretable, and effective in capturing the most important aspects of a program change. Our code embedding approach is based on a flexible weighting scheme, which can be modified to serve to different purposes. Using this weighting scheme, we are able to give more weight to the elements that we deem more important. % We conducted an experiment to manual evaluate our embedding method. The results show that after using our tool, in more than 85\% of the datapoints, the most important element is reported at least in the first three ranks.
