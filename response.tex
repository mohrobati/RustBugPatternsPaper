...
\vspace*{1em} \noindent \textbf{Response:} \todo{Need some argument here and some changes in the text.}
...
\vspace*{1em} \noindent \textbf{Response:} \todo{Probably just do what he asks.}
...
\vspace*{1em} \noindent \textbf{Response:} \todo{No argument, just paraphrase.}
...
\vspace*{1em} \noindent \textbf{Response:} \todo{First, we need some changes in paper text to make it clearer. Then, need some explanation here how we've changed it.}
